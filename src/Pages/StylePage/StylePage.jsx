  ...
  return (
    <div className={styles.Stylecontainer}>
     ...
     <div className={styles.styleBlock}>
        ...
        <img className={styles.styleImg} src="./public/ImgProj/lic1.png" alt="" />
      </div>
      ...
      <div className={styles.styleBlockcont}>
        ...
        <div className={styles.styleH}>
          ...
          <div className={styles.styleBlockP}>
            ...
            <p className={styles.styleParagraf}>Simply dummy text of the printing and typesetting industry. Lorem had ceased to been the industry's standard dummy <br /> text ever since the 1500s, when an unknown printer took a galley.established fact that a reader will be distracted by the <br /> readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less <br /> normal distribution of letters, as opposed.</p>
          </div>
          <div className={styles.styleList}>
            <h1 className={styles.List}>List</h1>
            <p className={styles.ListP}>1. Publishing packages and web pageLorem Ipsum as their default. <br /> 2. Content here, content here', making it look like readable. <br /> 3. Packages and web pageLorem Ipsum as their default</p>
          </div>
          <div className={styles.styleTextQ}>
            <h1 className={styles.textQ}>Quotes</h1>
            <p className={styles.QtextP}>“The first rule of any organic used in a business is that nature applied to an <br /> efficient operation will magnify the efficiency. The second is that organic applied <br /> to an inefficient operation will magnify the health.”</p>
          </div>
             ...
             <div className={styles.BlockButton}>
              ...
              <h3 className={styles.ButtonTextImg}> Default Button
              <img src="./public/imgProj/Aerrow.png" alt="123" /></h3>
              </div>
              </div>

             <div className={styles.BlockButton1}>
              <div className={styles.ButtonBlock1}>
              <h3 className={styles.ButtonTextImg1}> Default Button
              <img src="./public/imgProj/Aerrow.png" alt="123" /></h3>
              </div>
              </div>
             ...
             <div className={styles.BlockButton2}>
              ...
              <h3 className={styles.ButtonTextImg2}> Default Button
              <img src="./public/imgProj/Aerrow.png" alt="123" /></h3>
              </div>
              </div>
             ...
             <div className={styles.BlockButton3}>
              ...
              <h3 className={styles.ButtonTextImg3}> Default Button
              <img src="./public/imgProj/Aerrow.png" alt="123" /></h3>
              </div>
              </div>
